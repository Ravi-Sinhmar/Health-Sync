    ...
    <div className="min-h-screen bg-gray-50 pb-12">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          ...
          <div>
            <Card>
              <div className="flex justify-end text-violet-600">
              ...
              <div
                className={`overflow-hidden transition-all duration-300 ease-in-out ${expandedProfile ? "max-h-[1000px] opacity-100" : "max-h-0 opacity-0"
                  }`}
              >
            ...
            <Card>
              ...
              <div className="flex flex-col items-center p-4 border-b">
                <div className="w-16 h-16 bg-green-50 rounded-full flex items-center justify-center mb-2">
                  <GiHealthNormal className="text-green-600 text-lg" />
                </div>
                ...
                {isMobile && (
                  <button
                    ...
                    className="mt-2 px-4 py-1.5 bg-green-50 text-green-600 rounded-full text-xs font-medium flex items-center hover:bg-green-100 transition-colors"
                  >
                    {expandedHealth ? (
                      <>
                        Hide Details <FaChevronUp className="ml-1.5" />
              ...
              <div
                className={`overflow-hidden transition-all duration-300 ease-in-out ${expandedHealth ? "max-h-[1000px] opacity-100" : "max-h-0 opacity-0"
                  }`}
              >
                {/* Health Summary */}
                <div className="p-4 border-b">
