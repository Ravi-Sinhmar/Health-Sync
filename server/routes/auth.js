...
//     const user = await Student.findOneAndUpdate({ email }, { isVerified: true }, { new: true });
...
//     const user = await Student.findOneAndUpdate({ email }, { password: hashedPassword }, { new: true });

//     // Delete used OTP
//     await OTP.deleteOne({ _id: otpRecord._id });

//     // Set auth cookie after password reset
//     setAuthCookie(res, user._id, user.email);
